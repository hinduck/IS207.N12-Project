                                    ...
                                    <ul class="sub-cate">
                                        @foreach($category->subCategories as $subCategory)
                                            <li class="category-item">
                                                <a href="{{ route('product.category', ['category_slug' => $category->slug, 'sCategory_slug' => $subCategory->slug])}}" class="cat-link"><i class="fa fa-caret-right"></i>{{$subCategory->name}}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                @endif
