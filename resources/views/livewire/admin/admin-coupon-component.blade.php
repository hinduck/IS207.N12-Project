                                ...
                                @foreach($coupons as $coupon)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" onclick="return confirm('Are you sure to Delete this Coupon?') || event.stopImmediatePropagation()" style="margin-left: 10px;" wire:click.prevent="deleteCoupon({{$coupon->id}})">
