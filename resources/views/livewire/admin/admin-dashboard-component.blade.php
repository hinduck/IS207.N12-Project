        ...
        <div class="row">
                ...
                <div class="icon-stat">
                    <div class="row">
                        <div class="col-xs-8 text-left">
                            ...
                            <span class="icon-stat-value">{{ currency_format($totalRevenue) }}</span>
                        </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="icon-stat">
                    <div class="row">
                        <div class="col-xs-8 text-left">
                            <span class="icon-stat-label">SỐ LƯỢNG ĐÃ BÁN</span>
                ...
                <div class="icon-stat">
                    <div class="row">
                        <div class="col-xs-8 text-left">
                            ...
                            <span class="icon-stat-value">{{ currency_format($todayRevenue) }}</span>
                        </div>
                        <div class="col-xs-4 text-center">
                            <i class="fa fa-dollar icon-stat-visual bg-primary"></i>
                        </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="icon-stat">
                    <div class="row">
                        <div class="col-xs-8 text-left">
                            <span class="icon-stat-label">SỐ LƯỢNG HÔM NAY</span>
