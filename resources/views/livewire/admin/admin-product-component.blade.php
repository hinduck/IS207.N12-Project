                                ...
                                @foreach($products as $product)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" onclick="return confirm('Are you sure to Delete this Product?') || event.stopImmediatePropagation()" style="margin-left: 10px;" wire:click.prevent="deleteProduct({{$product->id}})">
